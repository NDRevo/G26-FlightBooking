...
<body>
	<%
		...
		try {
			...
			String entity = request.getParameter("airportid");
			//Make a SELECT query from the flight table with the airportid
			String str = "SELECT departureairport, destinationairport FROM flight WHERE departureairport = " + entity + " OR destinationairport = " + entity;
